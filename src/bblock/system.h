...
class System {
   public:
    ...
    void SetPolaris(std::vector<double> polaris);
     ...
     */
    void AddMonomer(std::vector<double> xyz, std::vector<std::string> atoms, std::vector<double> polaris, std::string id, size_t islocal = 1,
                    int tag = 0);                               //SY//
